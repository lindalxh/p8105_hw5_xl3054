...
The `homicide` dataset has `r nrow(homicide)` observations of criminal homicides over past decade in 50 cities in the US and 12 variables describing the demographic information of each victim, ID, date, location of each case, and whether an arrest was made.
...
city_results = city_unsolved %>%
  mutate(test = purrr::map2(unsolved, total, ~ suppressWarnings(prop.test(.x, .y))),
