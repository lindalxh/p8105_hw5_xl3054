...
The `homicide` dataset has 52179 observations of criminal homicides over
past decade in 50 cities in the US and 12 variables describing the
demographic information of each victim, ID, date, location of each case,
